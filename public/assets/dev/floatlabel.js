;(function ( $, window, document, undefined ) {
        ...
        Plugin.prototype = {
            ...
            showLabel: function() {
                var self = this;
                self.$label.css({ 'display' : 'block', 'color': 'white' });
                window.setTimeout(function() {
                    self.$label.css({
                    ...
                    if( self.settings.slideInput ) {
                        self.$element.css({ 'margin-top' : self.inputPaddingTop });
                    }
            ...
            hideLabel: function() {
                ...
                if( self.settings.slideInput ) {
                    self.$element.css({ 'margin-top' : parseFloat( self.inputPaddingTop ) - parseFloat(this.settings.paddingOffset) });
                }
